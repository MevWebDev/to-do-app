...
function checkDates() {
  ...
  _index__WEBPACK_IMPORTED_MODULE_0__.toDoList.projects.forEach((project) => {
    ...
    expiredTodos.forEach((todo) => {
      ...
      _index__WEBPACK_IMPORTED_MODULE_0__.toDoList.addActivityLog(todo, today.toLocaleString(), `expired`);
    });
  });
}
